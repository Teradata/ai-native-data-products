...
Implementations MAY include: environment lifecycle, container-retirement procedure, metadata/tagging, co-existence rules during migration, automation hooks. Agents read them if present.
